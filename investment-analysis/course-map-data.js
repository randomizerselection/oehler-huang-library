...
(function attachInvestmentCourseMap(global) {
  ...
  "generatorAccess": {
    ...
    "rules": [
      ...
      "Keep real cases, source extracts, company examples, security and fund examples, and investor profiles embedded throughout the syllabus; do not reserve cases for a final-only case-lab block.",
  ...
  function applyDecisionFirstSyllabus(map) {
    ...
    const lessonSpecs = [
      ...
      { n: 2, anchor: "Family saving plan", role: "family decision case", q: "How are saving, investing and speculation different?", judgementFocus: "the family saving decision", hook: "Should the family save, invest or speculate with all CNY 30,000? Give one reason.", idea: "Saving protects short-term needs, while investing accepts risk for possible future return.", tryIt: "Classify the near-term money, long-term surplus and rumour-led price bet as saving, investing or speculation with a reason.", naive: "Investing is always better than saving because possible return is higher.", missing: "Students need the purpose, time horizon, liquidity need, ability to accept loss and evidence quality for each part of the family money.", misconception: "Investing is always better than saving, and a rumour-led price bet is the same as investment analysis.", exit: "Save the CNY 12,000 needed soon, gather evidence before considering the CNY 18,000 long-term surplus for investment, and reject the rumour-led bet as speculation.", studentOutput: "Explain why the CNY 12,000 should be saved, why only the long-term surplus might be considered for investment, and why the rumour-led bet should be rejected as speculation.", terms: [["saving", "储蓄"], ["investment", "投资"], ["speculation", "投机"]], formula: "no new formula; students classify choices by purpose, time horizon, liquidity need, evidence and possible loss." },
      ...
      { n: 27, anchor: "Investor profile A", role: "mock investor profile", q: "Why can the same investment fit one person but not another?", hook: "Two students choose the same fund. Could one choice still be unsuitable?", idea: "Investor fit depends on goal, time horizon, liquidity need and risk tolerance.", tryIt: "Match investor profiles to suitable and unsuitable investment choices.", terms: [["investor profile", "投资者画像"], ["time horizon", "投资期限"]], formula: "no new formula; students match investment risk to investor profile." },
      ...
      { n: 34, anchor: "Corporate bond", role: "fixed-income security", q: "How can credit risk affect bond investors?", hook: "A corporate bond pays more. Is the extra yield free money?", idea: "Higher yield can compensate for higher credit risk, but it does not remove default risk.", tryIt: "Classify issuer evidence as credit strength or credit warning.", terms: [["credit risk", "信用风险"], ["issuer strength", "发行人实力"]], formula: "yield spread = corporate bond yield - safer benchmark yield." },
      ...
      { n: 39, anchor: "Monthly investment plan", role: "investment strategy", q: "How do compounding and gradual investing affect long-run accumulation?", topic: "compounding and gradual investing in long-run accumulation", hook: "Should an investor rely on one perfect purchase, or build a long-run plan over time?", idea: "Compounding can make long-run accumulation grow as returns build on earlier returns, while gradual investing can reduce timing pressure without guaranteeing profit.", tryIt: "Compare a simple compound-growth table with one lump-sum and one gradual-investing scenario.", terms: [["compounding", "复利"], ["dollar-cost averaging", "定期定额投资"]], formula: "future value = starting amount x (1 + return rate)^years; average purchase price = total amount invested / total units bought." },
      { n: 40, anchor: "Investor policy statement", role: "synthesis case", q: "What rules should guide an investor before choosing investments?", hook: "An investment looks exciting. What rule should stop a careless decision?", idea: "A written plan protects the decision process before emotion or news takes over.", tryIt: "Write simple plan rules for goal, risk, liquidity, evidence and action.", terms: [["investment policy statement", "投资政策说明"], ["written plan", "书面计划"]], formula: "no new formula; students write rules that constrain later choices." },
      ...
      { n: 50, anchor: "Final investment memo", role: "synthesis case", q: "How do students write a final evidence-based investment memo?", hook: "A careful investor has to choose a defensible next action. What belongs in the final memo?", idea: "The final memo combines the investment choice, evidence, return, risk, fit, alternatives, caveats and next action.", tryIt: "Write the final memo with dated evidence and a defensible classroom action.", terms: [["final investment memo", "最终投资备忘录"], ["investment caveat", "投资限制说明"]], formula: "synthesis of investment choice, return, risk, cost, fit and evidence; no new formula." }
    ];
    ...
    function makeSourcePack(spec) {
      return {
        ...
        snapshotDateFields: [
          ...
          "accessed date",
          "case anchor, security, fund or investment identifier",
          "key figure used",
          "evidence limitation"
        ],
        evidenceLimitations: [
    ...
    map.investmentWorkflow = [
      {
        ...
        studentAction: "Name the company, security, fund, bond, cash choice, portfolio holding or investor profile, and explain the ownership, lending claim or exposure.",
        evidenceCheck: "Record source title, publication date or accessed date, identifier, asset or instrument type and the figure being used.",
      ...
      },
      {
        ...
        decisionOutput: "This could fit, does not fit, or needs a safer investment choice for the profile."
      },
      {
        step: 3,
        title: "Read evidence",
    ...
    map.simpleLessonStructure = [
      {
        label: "Hook",
        purpose: "Start with a concrete company, security, fund, portfolio or investor-profile dilemma that students can answer before definitions.",
