(function attachInvestmentCourseMap(global) {
  ...
  function applyDecisionFirstSyllabus(map) {
    ...
    const lessonSpecs = [
      { n: 1, anchor: "Tencent", role: "listed company", q: "What is investment analysis?", hook: "Tencent is familiar. Would you buy shares in it?", idea: "Investment analysis judges potential return, risk and suitability before action.", tryIt: "Classify the missing evidence before making a Tencent judgement.", terms: [["investment analysis", "投资分析"], ["investor fit", "投资者适合度"]], formula: "no new formula; students classify evidence needs and explain in words only." },
      { n: 2, anchor: "Family saving plan", role: "financial product", q: "How are saving, investing and speculation different?", hook: "A family has money left over. Should it save, invest or speculate?", idea: "Saving protects short-term needs, while investing accepts risk for possible future return.", tryIt: "Sort actions into saving, investing and speculation with a reason.", terms: [["saving", "储蓄"], ["speculation", "投机"]], formula: "no new formula; students classify choices by goal, risk and time horizon." },
      ...
      { n: 5, anchor: "HKEX", role: "exchange/infrastructure case", q: "Why do investors need organised markets?", hook: "If you buy a share today, who gets the money and why does the market exist?", idea: "An exchange helps listed securities trade, but secondary trades do not always fund the company.", tryIt: "Match company, exchange, stock code and one market friction.", terms: [["stock exchange", "证券交易所"], ["secondary market", "二级市场"]], formula: "no new formula; students identify company, exchange, code and one trading friction accurately." },
      { n: 6, anchor: "Alibaba quote snapshot", role: "listed company", q: "What can a quote page tell us?", hook: "A quote page shows Alibaba's price. Is that enough to decide?", idea: "A quote page is a dated market snapshot, not a promise of value or execution.", tryIt: "Read one quote snapshot and separate what it tells from what it cannot prove.", terms: [["quote page", "报价页面"], ["bid-ask spread", "买卖价差"]], formula: "bid-ask spread = ask price - bid price." },
