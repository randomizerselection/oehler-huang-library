...
### Concept-led titles and uncluttered knowledge sequences, 23 September 2026

- Section dividers must name the key concept students are about to learn. Prefer **Market capitalisation**, **Calculating market capitalisation**, **Information and share prices** and **Stock splits and ownership** over narrative labels such as “One share and all shares”. Apply the same rule to teaching-slide titles: name the concept, calculation or causal relationship directly.
- Treat unclear titles, repeated framing and dense evidence displays as one structural problem. The key knowledge and question should dominate; move qualifications and teaching commentary into notes or source controls. Remove a slide when its work is already done by the preceding visual or following practice.
- Put proper independent calculation practice inside the section that teaches the method, before moving to the next concept. Keep the formula and inputs visible, protect an initial attempt, then reveal a complete model with the correct unit.
- For information and share prices, teach a concise mirrored mechanism: better-than-expected information → higher expected profits or lower risk → more buying and higher bids at the old price → higher agreed trade prices; worse-than-expected information can reverse these links. State that this is possible rather than guaranteed, and that a completed trade still has both buyer and seller.
- After the mirrored mechanism, give students two separate definition-type slides to copy: one sentence for a positive surprise and one sentence for a negative surprise. Each sentence must include the surprise relative to expectations, the revision to expected future profits, the change in demand/bids and the possible share-price direction. Make the three directional phrases revealable fill-in blanks so students must supply **better/raise/higher** or **worse/lower/lower** before copying the completed sentence. Put no second explanation or translation sentence on those slides.
- Make the opening company question visually dominant. Suppress a competing conventional title on full-screen photo questions. A short date/company label and one large question are enough.
- Teach information, expectations and company guidance on three separate, uncluttered picture-led slides rather than a three-column overview. Give each concept one short definition, one dated company example and one directly related company/product picture. Guidance is one type of information; investors compare it with prior expectations.
- Protect prerequisite order within examples. An early concept slide must use only ideas students have already learned; do not use a stock split to exemplify information before the stock-split section has explained what a split is. Prefer a familiar company and an immediately understandable reported result so attention stays on the new concept.
- Buyer/seller explanations should be simple visual sequences, not miniature order-book dashboards. One previous price, one expectation change, one changed bid and one accepted trade are sufficient for beginners.
- Historical company evidence should show only the numbers needed to make the comparison and the observed price response. Keep source accuracy and broader-market caveats in notes. For the January 2019 Apple case, the verified figures are prior quarterly revenue guidance of $89–93bn, revised guidance of about $84bn, and a 9.96% next-day close decline; Apple remained profitable and the wider market also fell.
- The revised Share price and company size lesson has 33 core slides and three optional slides. It includes two directional fill-in relationship definitions, three picture-led concept/example slides, one dedicated market-cap calculation practice, two formative hinge MCQs and four final MCQs. This clarity revision supersedes the earlier 32-core-slide structure while retaining the substantive NVIDIA, Apple and Nintendo knowledge.

### Information mechanisms and MCQ assessment, 22 September 2026

- The course's exams will be almost entirely multiple choice. Make exam-style practice, independent assessment and exits predominantly MCQs, including calculations, chart interpretation, applied causal chains and plausible misconception distractors. Do not default to Cambridge Economics-style long written responses or extended-answer marking schemes. Brief oral explanations or written working still support learning, but they are not the main exam format.
- Preserve the original question, data and all answer options during feedback. Reveal only after students commit. Explain why the best answer follows and why each plausible distractor fails; use mistakes to choose a specific diagram/model for reteaching. Original teacher-written MCQs must not be labelled official past-paper questions.
- Teach information and share-price movements in depth: new information → business prospects → expected profits/risk → willingness to buy/sell → bids/offers → agreed trade prices. Explain the profit-to-ownership link (dividends/reinvestment); sales are not profit, news does not mechanically set a price, and every completed trade has both a buyer and seller.
- Define information, expectations and company guidance clearly after a concrete mechanism. Show the difference between growth compared with last year and a surprise compared with expectations. Explain “priced in” without implying perfect information or a guaranteed price response.
- Use staged visual explanations, including a buyer/seller transaction, shared-zero expectation-versus-result bars and dated historical price evidence. Do not substitute a list of generic causal statements for teaching the missing links.
- Include contrasting real-company events: the current lesson uses NVIDIA's May 2023 sales forecast and Apple's January 2019 guidance cut. Distinguish observed price reactions from causal interpretation; identify other influences and forecast uncertainty. Label hypothetical numbers and periods clearly, including calendar versus fiscal dates.
- Protect time for this depth: the current 40-minute core allocates about 13 minutes to information, 10 to retrieval/market cap, 5 to splits, 9 to independent MCQs plus feedback, and 3 to Summary/buffer. The 23 September clarity revision has 31 core slides and three optional applications after Summary. The earlier written tasks remain replaced by four one-mark MCQs, including the exit; two copyable relationship definitions, a dedicated market-cap calculation and two formative hinge MCQs precede them.

### Real companies, substantive teaching and assessment, 22 September 2026

This later feedback overrides any earlier interpretation that a 40-minute Investment lesson should contain only one simple calculation and a small fixed number of slides.

- Use real companies wherever possible, with directly relevant images and dated sources. Prefer a connected real-company comparison to invented brands. Label rounded inputs, separately dated observations and hypothetical company scenarios explicitly; do not present a practice scenario as an actual corporate event.
- Teach enough connected knowledge for the full period. Plan the explanations and skills first, then allocate time for independent attempts and feedback. Simplicity means clear stages and readable slides, not withholding essential reasoning or stretching one multiplication across 40 minutes. Avoid repeating the same calculation merely to add length.
- For Share price and company size, the core now connects market capitalisation, expectations and trading prices, price changes with a fixed share count, market value versus company cash, and stock splits with unchanged proportional ownership. Nintendo's split is core, not merely an optional curiosity. Do not treat this prepared material as confirmed taught.
- Build formative assessment into the transitions: retrieve prerequisites; ask students to commit to predictions; use application-based hinge questions with misconception-specific feedback; require independent calculation and causal explanation. If a hinge fails, the notes should identify the model to revisit.
- Include original exam-style practice with marks, adequate independent response time and separately revealed reasoning. Follow the later MCQ-format clarification above; preserve the question, data and options during feedback. Clearly distinguish teacher-written material from official examinations.
- Protect a genuinely independent assessed exit, then Summary. Spare-time questions belong after the core ending. Slide count is subordinate to coherent teaching and realistic pacing; neither a rigid 14–16-slide ceiling nor needless expansion should determine the curriculum.
- This intermediate revision had 26 core slides and written structured practice; the later information-depth/MCQ revision above supersedes its scope and assessment format. Source IDs survive, including the historical `nintendo-split-extension` ID now used for core content.

### Stronger Investment lesson design, 22 September 2026

- Explicit teacher feedback: Share price and company size was weaker and less engaging than the newest IGCSE and A-level decks. Simpler content must still have a carefully designed visual explanation, systematic progression and active student participation. Do not interpret “less clutter” as mostly static text or repeated definitions.
- Benchmarks reviewed: linked IGCSE 5.3 Population growth (counted changes before definitions), A-level 9.2.3 Business cycle (a reversible visual puzzle before the formal model), and 9.2.4 Growth policies (specific photographs connected to the following explanation and practice). Borrow their instructional design while keeping Investment's renderer and paper/forest/copper identity.
- Complete retrieval first. After a picture-led section divider, pose one concrete question whose answer is not already disclosed on the cover. Let students commit to a prediction, reveal the missing evidence, and return to that prediction after teaching the method.
- Give the central relationship a visual model students can read and explain: counted ownership units, a shared-scale comparison, or a changing quantity with other inputs held fixed. Use accurate labels and units. A collection of text cards called a “visual” is insufficient.
- Carry one principal case through the explanation, formula and full worked model. Use manageable figures before introducing millions/billions conversion in practice. Keep the original question and inputs visible throughout each answer reveal.
- Design each composition for its purpose: image comparison for the hook, counted diagram for the mechanism, large annotated formula for the method, numerical table for practice, and open prose for the final explanation. Avoid repeating the same two-card composition across the lesson.
- Reveal calculation steps and comparison results one at a time, reversibly. Do not accidentally reveal the conclusion in the title before students attempt the task. Keep answers out of initial task states and hide model answers independently from navigation.
- Engagement should ask students to predict, calculate, compare or explain a counterexample. Insert a hinge question that changes the conditions rather than repeating the definition. Include misconception-specific teacher feedback and a clear independent exit criterion.
- Keep bilingual instructional text readable at the normal 1280×720 classroom viewport. Reserve small text for sources/navigation. Use directly relevant local photos at transitions and on company hooks; photos of a fictional company's sector must not be presented as that company's real premises or products.
- End core learning with an assessed exit and a concise Summary. Protect independent work and discussion time. Put interesting but nonessential applications after Summary, explicitly optional. A 17-slide core is acceptable where this supports the teaching sequence; do not add concepts merely to fill slides.
- Share-price redesign reference: `apps/library/investment-analysis/lessons/share-price-company-size/`. The initial 17-slide version was superseded by the later real-company/content-depth feedback above. Keep lesson-local compositions local unless a broader renderer change is requested. Preserve semantic slide IDs, including `exit-market-cap`.

### Simpler knowledge lessons and pre-exam sequence, 22 September 2026

- Students were overwhelmed by the amount and density of material in the prepared Assumed return lesson. It was not taught successfully. Keep `lessons/1-1-3-assumed-return/` as an unlinked legacy reference; do not restore it to the active catalogue or treat its annualised-return and forecast-assumption content as taught.
- Do not teach Nominal and real return before the September monthly exam. Preserve the prepared lesson for possible later use, but label it as deferred rather than current pre-exam teaching.
- Before the monthly exam, the confirmed sequence is: What is investment? (including investment versus speculation), Measuring investment return, Compound growth, Planning your first stock trades, and Share price and company size. Follow this with focused revision rather than another new content lesson.
- Earlier simplification guidance favoured one central relationship and roughly 14–16 core slides. The later feedback above supersedes these as fixed limits: preserve one coherent line of enquiry, while teaching sufficient connected knowledge and assessing it properly. Do not add unrelated methods or dense frameworks merely to fill the period.
- Preserve a knowledge-acquisition structure: concrete question → mechanism → concise definition or formula → worked model → independent application → check and exit. Portfolio or submission follow-up may appear briefly, but it must not become the organising structure of a whole-class lesson.
