...
Prepared 15 September 2026. This is the next active IGCSE Economics HTML deck after Central banks. Preparation does not imply that the lesson has been taught.

## Canonical files and sequence

- Edit `apps/library/lessons/unit-3-decision-makers/3-2-households/slides.js` directly for future classroom feedback. Preserve its stable slide IDs.
- `index.html`, `households.css`, `households.js` and `sources.js` are owned by this lesson. No shared renderer or sibling course implementation was changed.
- The course landing page links all four views immediately after Money and banking: lesson, handout, quiz and flashcards.
- The scripts in this authoring folder are retained one-off creation/research provenance, not a rebuild workflow. Do not rerun the bootstrap builders over later edits to the canonical lesson.

## Syllabus and definitions audit

The original local **IGCSE Economics Syllabus (2027–2029).pdf**, printed/PDF page 16, names:
...
Question PDFs and their matching official mark schemes were read from `C:/Users/oehle/Documents/past-papers/`. Paper 1 pages were also rendered to check table columns, rows and option order. Earlier topic-indexed mark-scheme summaries were used for discovery; original PDFs were the final check.

| Paper | Question paper page | Mark scheme page | Use and verified answer/basis |
|---|---:|---:|---|
| 0455/11 O/N/2025 Q11 | 5 | 2 | Positive saving from the six-row income/spending table. **D: $5200**, saving $225. $4900 gives zero saving. |
| 0455/12 O/N/2022 Q11 | 5 | 2 | Income groups and the percentage saved. **D**. Original stem and options retained. |
| 0455/11 M/J/2025 Q11 | 5 | 2 | Lower rates: saving decreases, borrowing increases. **B**. Columns are saving, then borrowing. Q10 in this paper was discounted; it is not used. |
| 0455/21 M/J/2023 Q5(a) | 5 | 20 | Identify two reasons rich households spend more [2]. Higher income and easier borrowing are two accepted answers. |
| 0455/23 O/N/2024 Q2(a) | 4 | 13 | Identify two influences on the proportion saved [2]. Use two distinct influences; the scheme accepts more than the five syllabus headings. |
| 0455/22 F/M/2025 Q1(d) | source 2; question 3 | 8 | Explain two reasons spending increased in Romania [4]. Exact relevant paragraph retained. Confidence and low interest rates support two developed explanations. |
| 0455/21 O/N/2024 Q5(b) | 5 | 24 | Exit: effects of an ageing population on spending and saving [4]. Scheme accepts retirement preparation and drawing down accumulated savings; maximum 3 for explaining only one variable. |

Related archive entries: `3-microeconomic-decision-makers.md` — 2023MJ-21 Q5(a), 2024ON-23 Q2(a), 2025FM-22 Q1(d); `5-economic-development.md` — 2024ON-21 Q5(b).

Original Cambridge wording, data and option order are preserved. MCQ explanations, worked numerical teaching, recall questions, application checks and model prose are teacher-written. The source buttons distinguish Question paper, Mark scheme and Teaching model. They support Escape, explicit close, backdrop dismissal and focus restoration. They do not advance the lesson.
...
- Lucy is a fictional adult earning ¥5,000 after tax monthly. Current purchases cost ¥4,000; saving is ¥1,000. With no unexpected costs, price changes or interest, two months of saving can fund the ¥2,000 laptop before the four-month deadline.
- The borrowing alternative assumes no accumulated savings, a ¥2,000 principal outstanding for one year, 5% simple annual interest, no fees and one final repayment: ¥2,100. Borrowing does not become earned income.
- The income comparison is illustrative, not a prediction: ¥5,000 income/¥4,000 spending/20% saved; ¥8,000 income/¥5,600 spending/30% saved. Higher income can increase both amounts; a larger saving share is a tendency, not a certainty.
- Interest calculations hold ¥2,000 and one year constant: 2% gives ¥40; 5% gives ¥100. The rate comparison states the formula and time assumption. New/variable-rate borrowing may respond differently from existing fixed-rate contracts.
- Less confidence can increase desired precautionary saving while income is unchanged. Actual income loss can reduce the ability to save.
- Age and culture are influences, not rules for every individual. An ageing population is defined in the age teaching notes before the cross-topic exit.

## Design and study views
