    ...
    },
    {
      ...
      facts: {
        left: {
          ...
          context: 'Global growth was projected at 2.6% in 2024, below the 3.1% average in the decade before COVID-19.',
          question: 'Which macroeconomic aim is shown, and why might governments care about it?',
          questionZh: '这里体现了哪个宏观经济目标，政府为什么重视它？',
          answer: 'The aim is economic growth; governments care because growth can raise incomes, output and living standards.',
        ...
        china: {
          flag: '🇨🇳',
          country: 'China',
          context: 'Real GDP grew 5.0% in 2024,.',
          question: 'Which macroeconomic aim is shown, and why might governments care about it?',
          questionZh: '这里体现了哪个宏观经济目标，政府为什么重视它？',
          answer: 'The aim is economic growth; governments care because growth can raise incomes, output and living standards.',
    ...
    },
    {
      ...
      facts: {
        left: {
          flag: '🌐',
          country: 'World economy',
          context: 'Global inflation was expected to fall to 3.5% in 2024 and 2.9% in 2025, so stable prices remained a policy aim.',
          question: 'Which macroeconomic aim is shown, and what problem can high inflation create?',
          questionZh: '这里体现了哪个宏观经济目标，高通胀会造成什么问题？',
          answer: 'The aim is stable prices; high inflation reduces purchasing power and creates uncertainty.',
        ...
        china: {
          flag: '🇨🇳',
          country: 'China',
          context: 'Consumer prices rose 0.2% in 2024,.',
          question: 'Which macroeconomic aim is shown, and what problem can high inflation create?',
          questionZh: '这里体现了哪个宏观经济目标，高通胀会造成什么问题？',
          answer: 'The aim is stable prices; high inflation reduces purchasing power and creates uncertainty.',
    ...
    },
    {
      ...
      facts: {
        left: {
          ...
          context: 'Global unemployment was steady at 5% in 2024, while youth unemployment remained much higher at 12.6%.',
        ...
        china: {
          flag: '🇨🇳',
          country: 'China',
          context: 'The surveyed urban unemployment rate averaged 5.1% in 2024.',
          question: 'Which macroeconomic aim is shown, and what cost can unemployment create?',
          questionZh: '这里体现了哪个宏观经济目标，失业会造成什么成本？',
          answer: 'The aim is low unemployment; unemployment wastes labour and reduces household income.',
