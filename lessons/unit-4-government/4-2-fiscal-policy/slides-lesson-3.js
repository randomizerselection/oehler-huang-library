...
IGCSE.lesson = {
  ...
  slides: [
        ...
        },
    {
          ...
          fact: 'The UK income tax system has bands of 0%, 20%, 40% and 45% in the 2026-27 tax year. Higher taxable income can face a higher marginal tax rate, so this introduces progressive tax.',
        ...
        },
    {
          ...
          flag: '🇯🇵',
          country: 'Japan',
          fact: 'Japan has a 10% standard consumption tax rate, with an 8% reduced rate for some items. A consumption tax can be regressive if lower-income households spend a larger share of their income.',
        ...
        },
    {
          ...
          flag: '🇭🇺',
          country: 'Hungary',
          fact: 'Hungary sets personal income tax at 15% in 2026. A single percentage rate on income introduces proportional tax, even though higher earners pay more money in total.',
