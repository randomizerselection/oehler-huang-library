...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      zhTitle: '紧缩性政策',
      nodes: [['lower spending or higher taxes', 'aggregate demand falls', 'less pressure to raise prices', 'demand-pull inflation may fall']],
    ...
    },
    {
      ...
      cards: [
        ...
        ['Price stability', 'reduce demand-pull inflation pressure'],
    ...
    },
    {
      ...
      zhTitle: '价格稳定',
      nodes: [['higher taxes or lower spending', 'aggregate demand falls', 'less pressure to raise prices', 'demand-pull inflation may fall']],
      footer: 'Risk: output and employment may fall.',
      visual: photos.inflation,
      partialReview: ['.flowRow > .flowChip', '.prompt'],
    },
