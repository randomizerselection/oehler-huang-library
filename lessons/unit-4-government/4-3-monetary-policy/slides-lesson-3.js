...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      type: 'peerTask',
      eyebrow: 'Pair check',
      prompt: 'Classify each situation as needing larger money supply or smaller money supply.',
      zhPrompt: '两人合作完成三步，然后准备分享一个完整答案。',
      steps: [
        ['1', 'Unemployment is rising and output is weak: larger OR smaller money supply?'],
        ['2', 'Demand-pull inflation is high: larger OR smaller money supply?'],
        ['3', 'Banks are not lending enough to firms: larger OR smaller money supply?'],
      ],
      sharePrompt: 'Share one classification and the macro aim it targets.',
      sampleAnswers: ['Weak output and rising unemployment may need a larger money supply because more bank lending can increase spending, investment, output and employment.'],
    ...
    },
    {
      type: 'peerTask',
      eyebrow: 'Pair check',
      prompt: 'Classify each exchange-rate effect as exports, imports or both.',
      zhPrompt: '两人合作完成三步，然后准备分享一个完整答案。',
      steps: [
        ['1', 'Lower exchange rate makes exports cheaper for foreign buyers: exports, imports or both?'],
        ['2', 'Lower exchange rate makes imports more expensive for domestic buyers: exports, imports or both?'],
        ['3', 'Higher exchange rate makes imports cheaper: exports, imports or both?'],
      ],
      sharePrompt: 'Share one classification and the price direction.',
      sampleAnswers: ['A lower exchange rate affects imports because domestic buyers must pay more for foreign goods, so import spending may fall.'],
      partialReview: ['.peerTaskSamples > .choice'],
    },
    {
      type: 'flow',
