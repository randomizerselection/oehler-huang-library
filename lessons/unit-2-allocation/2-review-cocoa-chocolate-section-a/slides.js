  ...
  slides: [
    ...
    },
    {
      ...
      left: [
        ...
        ['3', 'case examples: chocolate manufacturers and __________', 'supermarkets'],
      ],
      rightTitle: 'Public sector',
      right: [
        ['1', 'owned or controlled by __________', 'government'],
        ['2', 'often provides services or regulates __________', 'activity'],
        ['3', 'case example: Ghana Cocoa __________', 'Board'],
