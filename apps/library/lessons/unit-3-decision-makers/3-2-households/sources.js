...
(() => {
  ...
  if(!slides.length || !document.body.classList.contains('household-classroom')) return;
  ...
  function records(s) {
    ...
    if(s.notes&&s.layout?.startsWith('household-'))list.push({type:'Teaching notes',ref:'Explanation, assumptions and classroom use',detail:s.notes});
