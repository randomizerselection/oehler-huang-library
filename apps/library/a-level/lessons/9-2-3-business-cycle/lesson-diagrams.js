...
(function () {
  ...
  function fiscal(id){
    ...
    b+=group(line(260,188.75,590,436.25,'demand')+t(559,394,'AD₁','blue-text')+dot(p.x,p.y)+t(p.x-25,p.y-16,'E₁','small')+line(85,p.y,p.x,p.y,'guide')+t(74,p.y+5,'P₁','small','end')+line(p.x,p.y,p.x,460,'guide')+t(p.x,513,'Y₁','small','middle'),1);
