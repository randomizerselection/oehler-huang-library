(function () {
  ...
  const scenes={
    ...
    'gaps-both':{model:'paired-gaps',steps:[
      ...
      step('£650m planned: a £50m inflationary gap','High AE = 200 + 0.75Y.\nAt Y = 600, AE = 650.\nExcess: 650 − 600 = £50m.','E* assumes fixed prices. Excess demand puts upward pressure on prices.'),
      step('The negative output gap is £200m','Output gap = actual output − potential output.\nAt E₀: 400 − 600 = −£200m.\nThe horizontal shortfall is 200; the vertical spending gap is 50.','E* is a notional fixed-price intersection, not measured actual output.')
    ]},
