...
<body class="investment-home investment-definitions-page">
  ...
  <main class="investment-page">
    <header class="investment-nav oh-app-header" aria-label="Platform navigation">
      <a class="investment-link oh-app-brand" href="../index.html" aria-label="Oehler-Huang Learning Platform home">
        <span class="oh-app-mark" aria-hidden="true">OH</span>
        <span><strong>Oehler-Huang</strong><small>Learning Platform</small></span>
      </a>
      <nav class="investment-nav-links oh-primary-nav" aria-label="Primary destinations">
        <a class="investment-link" data-oh-nav="economics" href="../economics/index.html">Economics</a>
        <a class="investment-link is-current" data-oh-nav="investment" href="index.html" aria-current="page">Investment</a>
        <a class="investment-link" data-oh-nav="homework" href="/mark/">Homework</a>
      </nav>
      <div class="oh-header-account" data-oh-account-dock></div>
    </header>
    <div class="oh-context-bar" style="--oh-context-accent:#7ef0b5">
      <strong class="oh-context-label">Investment</strong>
      <nav class="oh-context-nav" aria-label="Investment course resources">
