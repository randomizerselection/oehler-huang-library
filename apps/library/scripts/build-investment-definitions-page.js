...
function renderDefinitionPage(sections = getCourseMapDefinitionSections()) {
  ...
  const total = sections.reduce((sum, section) => sum + section.entries.length, 0);
  const lessonCount = financialDecisionCourseMap.lessons.length;
...
<head>
  ...
  <meta name="description" content="Active definitions for the ${lessonCount}-lesson Investment and Financial Decision-Making course." />
  <meta name="author" content="Samuel Oehler-Huang" />
  <title>${escapeHtml(title)} - 学思札记</title>
...
<body class="investment-home investment-definitions-page">
  ...
  <main class="investment-page">
    <nav class="investment-nav" aria-label="Investment Analysis definitions navigation">
      <a class="investment-link" href="../index.html">学思札记 / Site home</a>
      ...
      <div class="platformAccountMount" data-platform-account></div>
    </nav>
    ...
    <header class="investment-hero investment-definition-hero">
      <div class="investment-hero-copy">
        ...
        <p>
          Active course definitions for all ${total} key terms used across the ${lessonCount}-lesson course, with Chinese term support, ${matchedTotal} CFA Program glossary source matches and ${textbookMatchedTotal} local textbook source matches shown beside the classroom wording.
        </p>
...
${renderDefinitionSections(sections, cfaMatchMap, textbookDefinitionMap, cfaSourceUrl)}
  ...
  <script src="../assets/js/platform-auth.js"></script>
</body>
</html>
`;
}
