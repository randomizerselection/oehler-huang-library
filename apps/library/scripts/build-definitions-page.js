...
<head>
  ...
  <script src="assets/js/library-home.js" defer></script>
</head>
<body class="bg-ambient">
  ...
  <main class="definition-page">
    <header class="landing-nav oh-app-header" aria-label="Platform navigation">
      <a class="landing-brand oh-app-brand" href="index.html" aria-label="Oehler-Huang Learning Platform home">
        <span class="landing-brand-mark oh-app-mark" aria-hidden="true">OH</span>
        <span><strong>Oehler-Huang</strong><small>Learning Platform</small></span>
      </a>
      <nav class="landing-nav-links oh-primary-nav" aria-label="Primary destinations">
        <a class="landing-nav-link is-current" data-oh-nav="economics" href="economics/index.html" aria-current="page">Economics</a>
        <a class="landing-nav-link" data-oh-nav="investment" href="investment-analysis/index.html">Investment</a>
        <a class="landing-nav-link" data-oh-nav="homework" href="/mark/">Homework</a>
      </nav>
      <div class="oh-header-account" data-oh-account-dock></div>
    </header>
    <div class="oh-context-bar" style="--oh-context-accent:#56d8ff">
      <strong class="oh-context-label">Economics</strong>
      <nav class="oh-context-nav" aria-label="Economics resources">
        <a href="economics/index.html">Lessons</a>
        <a href="definitions.html" aria-current="page">Definitions</a>
        <a href="pedagogy.html">Teaching approach</a>
      </nav>
    </div>
