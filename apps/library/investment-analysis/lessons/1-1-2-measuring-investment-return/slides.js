...
window.INVESTMENT_COURSE.lesson = {
  ...
  slides: [
    ...
    { id: 'partner-attempt', kind: 'case', group: 'AMOUNT VS PERCENTAGE', title: 'Real market comparison · Apple and Coca-Cola in 2026', prompt: 'Emma bought Apple shares and Leo bought Coca-Cola shares on 31 December 2025. Using the figures below for the period ending 31 July 2026, calculate their return amounts and ending values, then compare who earned more money and who achieved the higher percentage return.', left: { title: 'Emma · Apple shares', photo: photos.apple, lines: ['Amount invested  US$20,000', 'Total return  13.8%', 'Return amount  ______', 'Ending value  ______'] }, right: { title: 'Leo · Coca-Cola shares', photo: photos.cocaCola, lines: ['Amount invested  US$10,000', 'Total return  26.8%', 'Return amount  ______', 'Ending value  ______'] }, note: 'The named investors and amounts invested are hypothetical, but both percentage returns use the same real 31 December 2025 to 31 July 2026 market period. Fees and tax are excluded.', sources: [sources.applePrices2026, sources.appleDividends, sources.cocaColaPrices2026, sources.cocaColaDividendQ1_2026, sources.cocaColaDividendQ2_2026] },
    { id: 'partner-reveal', kind: 'case', partialReveal: true, group: 'AMOUNT VS PERCENTAGE', reveal: true, title: 'Apple and Coca-Cola · Model answer', prompt: 'Leo’s Coca-Cola shares achieved the higher percentage return. Emma’s larger investment in Apple shares earned the greater dollar return amount.', left: { title: 'Emma · Apple shares', photo: photos.apple, lines: ['Return amount  US$2,760', 'Ending value  US$22,760', 'Higher amount: US$2,760'] }, right: { title: 'Leo · Coca-Cola shares', photo: photos.cocaCola, lines: ['Return amount  US$2,680', 'Ending value  US$12,680', 'Higher percentage: 26.8%'] }, note: 'Reveal the two model-answer cards one at a time. This current real-market comparison preserves the deliberate difference between the amount ranking and the percentage ranking.', sources: [sources.applePrices2026, sources.appleDividends, sources.cocaColaPrices2026, sources.cocaColaDividendQ1_2026, sources.cocaColaDividendQ2_2026] },
